...
<fmt:bundle basename="com.alkacon.opencms.v8.login.messages">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">Max Mustermann <b class="caret"></b></a>
        ...
        <li>
            <a style="padding: 0" href="">
                <span style="font-size: 27px; vertical-align: middle; line-height: 180%; color: #fff; margin-right: -11px; z-index: -1;" class="glyphicon glyphicon-info-sign"></span>
                <span style="background-color: #f00" class="badge">2</span>
            </a>
        </li>
        <li>
            <p class="navbar-text">14:39</p>
        </li>
    </ul>
